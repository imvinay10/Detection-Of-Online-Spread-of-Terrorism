...
class Startpage(ttk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        img=ImageTk.PhotoImage(Image.open(r"D:\Projects\terrorism 123\wallpaper.jpg").resize((1200,700)))   # set the home page image
        img.image = img
...
class PageOne(ttk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        j=[]
        f = open(r"D:\Projects\terrorism 123\keywords.txt")
        for line in f:
            j.append(line.strip())
        f.close()
        d = dict.fromkeys(j,0)
...
# set app icon
icon = ImageTk.PhotoImage(Image.open(r"D:\Projects\terrorism 123\icon.jpg"))
